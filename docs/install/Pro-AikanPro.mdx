...
<a target="_blank" rel="noopener noreferrer">
<img width="100" src="/img/install/pro-linux-02.jpg" width="1000" height="400"  /> </a>
- 在源码目录里面找到数据库配置文件，进行数据库配置修改
<a target="_blank" rel="noopener noreferrer">
<img width="100" src="/img/install/pro-linux-03.jpg" width="1000" height="550"  /> </a>
- 打开域名完成后台
<a target="_blank" rel="noopener noreferrer">
<img width="100" src="/img/install/pro-linux-04.jpg" width="800" height="500"  /> </a>
